...
const store = createStore({
    ...
    mutations: {
        ...
        setStudentProjects(state, payload) {
    ...
    actions: {
        ...
        async fetchStudentProjects({ commit }) {
            const data = await getDocs(collection(db, "studentProjects"));
            commit("setStudentProjects", data);
        },
